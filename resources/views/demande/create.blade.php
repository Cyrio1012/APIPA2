        ...
        <form method="POST" action="{{ route('demande.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="date" name="date_arrivee_apipa" class="form-control" value="{{ old('date_arrivee_apipa') }}">
                </div>
                <div class="col-md-4">
                    <label for="date_commission_apipa" class="form-label">Date commission APIPA</label>
                    <input type="date" name="date_commission_apipa" class="form-control" value="{{ old('date_commission_apipa') }}">
                </div>
                <div class="col-md-4">
                    <label for="date_definitive" class="form-label">Date définitive</label>
                    <input type="date" name="date_definitive" class="form-control" value="{{ old('date_definitive') }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" step="0.01" name="superficie_m2" class="form-control" value="{{ old('superficie_m2') }}">
                </div>
                <div class="col-md-6">
                    <label for="superficie_demandee_m2" class="form-label">Superficie demandée (m²)</label>
                    <input type="number" step="0.01" name="superficie_demandee_m2" class="form-control" value="{{ old('superficie_demandee_m2') }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="immatriculation_terrain" class="form-control" value="{{ old('immatriculation_terrain') }}">
                </div>
                <div class="col-md-6">
                    <label for="prescription_urbanisme" class="form-label">Prescription urbanisme</label>
                    <input type="text" name="prescription_urbanisme" class="form-control" value="{{ old('prescription_urbanisme') }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="service_envoyeur" class="form-control" value="{{ old('service_envoyeur') }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="avis_paiement" class="form-control" value="{{ old('avis_paiement') }}">
                </div>
                <div class="col-md-4">
                    <label for="montant_redevance" class="form-label">Montant redevance</label>
                    <input type="number" step="0.01" name="montant_redevance" class="form-control" value="{{ old('montant_redevance') }}">
                </div>
                <div class="col-md-4">
                    <label for="situation_redevance" class="form-label">Situation redevance</label>
                    <input type="text" name="situation_redevance" class="form-control" value="{{ old('situation_redevance') }}">
                </div>
            </div>
            ...
            @foreach(['avis_commission_descente', 'observation_commission', 'avis_definitif'] as $textarea)
                <div class="mb-3">
                    <label for="{{ $textarea }}" class="form-label">{{ ucfirst(str_replace('_', ' ', $textarea)) }}</label>
